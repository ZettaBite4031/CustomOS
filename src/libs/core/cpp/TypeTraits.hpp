...
template<typename T> class MakeUnsigned { public: typedef T Type; };

template<> class MakeUnsigned<char> { public: typedef unsigned char Type; };
template<> class MakeUnsigned<short> { public: typedef unsigned short Type; };
template<> class MakeUnsigned<int> { public: typedef unsigned int Type; };
template<> class MakeUnsigned<long> { public: typedef unsigned long Type; };
template<> class MakeUnsigned<long long> { public: typedef unsigned long long Type; };

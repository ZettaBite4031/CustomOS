...
echo "#include \"idt.hpp\"" >> $ISRS_GEN_C
echo "#include \"gdt.h\"" >> $ISRS_GEN_C
echo "" >> $ISRS_GEN_C

for i in $(seq 0 255); do
    echo "extern \"C\" void __attribute((cdecl)) i686_ISR${i}();" >> $ISRS_GEN_C
done
...
for i in $(seq 0 255); do
    echo "    i686_IDT_SetGate(${i}, (void*)i686_ISR${i}, i686_GDT_CODE_SEGMENT, IDT_FLAG_RING0 | IDT_FLAG_GATE_32BIT_INT);" >> $ISRS_GEN_C
done
